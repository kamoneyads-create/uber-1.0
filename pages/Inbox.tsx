...
const Inbox: React.FC = () => {
  const [messages, setMessages] = useState([
    { id: 1, sender: 'Uber', text: 'Você recebeu um bônus de R$ 50,00 por completar 10 viagens hoje!', time: '10:30', read: false },
    { id: 2, sender: 'Suporte', text: 'Sua conta está em conformidade. Continue o bom trabalho!', time: 'Ontem', read: true },
  ]);
