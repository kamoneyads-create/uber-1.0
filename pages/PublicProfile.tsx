...
const PublicProfile: React.FC<PublicProfileProps> = ({ userName, profileImage, onBack, language }) => {
  const elogios = [
  ...
  return (
    <div className="h-full bg-white flex flex-col overflow-y-auto select-none animate-in fade-in duration-300 pb-20 scrollbar-hide">
