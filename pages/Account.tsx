...
const Account: React.FC<AccountProps> = ({ onBack, vehicleName, licensePlate, onLogout, onDocuments, onVehicles }) => {
  const mainItems = [
    {
      id: 'vehicle',
      title: 'Veículos',
      subtitle: `${vehicleName} ${licensePlate}`,
      icon: <i className="fa-solid fa-car text-[20px] text-black"></i>,
      action: onVehicles
    },
    {
      id: 'documents',
  ...
  return (
    <div className="h-full bg-white flex flex-col select-none animate-in fade-in slide-in-from-right duration-300 overflow-y-auto">
      {/* Header */}
