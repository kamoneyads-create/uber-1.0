...
const Profile: React.FC<ProfileProps> = ({ userName, profileImage, onLogout, onDetail, onEdit, onAccount, onBack }) => {
  return (
    <div className="h-full bg-white flex flex-col overflow-y-auto scrollbar-hide pt-12 px-8 select-none animate-in fade-in duration-300 pb-40">
      {/* User Header Section */}
      <div 
        ...
        <div className="flex items-start gap-6">
          <div className="relative shrink-0 w-[72px] h-[72px]">
            <img 
              ...
              alt={userName} 
              className="w-full h-full rounded-full object-cover shadow-sm shrink-0 aspect-square border border-gray-100"
              onError={(e) => {
          ...
          <div className="flex flex-col pt-2">
            <h2 className="text-[22px] font-bold text-black tracking-tight leading-tight">{userName || "Junior"}</h2>
      ...
      <div className="flex flex-col space-y-[26px] mb-12">
        ...
        <div className="flex items-center gap-3 active:opacity-50 transition-opacity cursor-pointer">
