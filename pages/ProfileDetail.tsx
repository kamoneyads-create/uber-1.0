...
const ProfileDetail: React.FC<ProfileDetailProps> = ({ userName, profileImage, onBack, onPublicProfile }) => {
  return (
    <div className="h-full bg-white flex flex-col overflow-y-auto pt-4 px-6 select-none pb-20">
      ...
      <div className="pt-4 mb-6">
        ...
        <h1 className="text-[32px] font-black text-black tracking-tighter mt-3 leading-none animate-in fade-in slide-in-from-left duration-500 delay-150 fill-mode-backwards">
          Perfil
        </h1>
      </div>

      {/* Main User Info Card */}
      <div className="bg-white rounded-[20px] border border-gray-100 p-6 shadow-sm flex items-center gap-5 mb-8 animate-in fade-in slide-in-from-bottom duration-500 delay-200 fill-mode-backwards">
        <div className="relative">
          {/* Blue ring around avatar */}
          <div className="w-[86px] h-[86px] rounded-full border-[2.5px] border-[#276EF1] flex items-center justify-center p-0.5">
            <img 
              src={profileImage} 
              alt={userName} 
      ...
      {/* Viagens Section */}
      <div className="flex items-center justify-between mb-5 pr-1 animate-in fade-in slide-in-from-bottom duration-500 delay-300 fill-mode-backwards">
      ...
      {/* Stats Cards */}
      <div className="grid grid-cols-2 gap-3 mb-10 animate-in fade-in slide-in-from-bottom duration-500 delay-400 fill-mode-backwards">
        <div className="bg-white rounded-[20px] border border-gray-100 p-5 shadow-sm flex flex-col justify-between min-h-[160px] overflow-hidden">
          <div>
            <h4 className="text-[28px] font-black text-black leading-none mb-3">0%</h4>
            <p className="text-[15px] font-bold text-black leading-tight">Taxa de cancelamento</p>
          </div>
          <div className="mt-3">
             <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-red-50">
               <i className="fa-solid fa-triangle-exclamation text-red-600 text-[9px]"></i>
               <span className="text-[10px] font-black text-red-600">Uber Pro</span>
             </div>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between mb-12 pr-1 animate-in fade-in slide-in-from-bottom duration-500 delay-500 fill-mode-backwards">
